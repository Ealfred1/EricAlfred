export const SKILLS = [
	{
		title: "Frontend",
		icon: "pi pi-pen-to-square skill-img",
		skills: [
	...
	{
		title: "Soft Skills",
		icon: "pi pi-user skill-img",
		skills: [
			{ skill: "Problem-Solving", percentage: "98%" },
			{ skill: "Collaboration ", percentage: "100%" },
			{ skill: "Attention to Detail", percentage: "99%" },
			{ skill: "Creativity", percentage: "97%" },
		],
	},
]