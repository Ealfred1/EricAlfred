...
const Projects = () => {
	...
	return (
		...
		<div className="progress sticky top-0 left-0 pt-[50px] text-center text-white text-[2rem] md:text-6xl font-bold bg-[#060417] backdrop-blur-3xl z-[1000] rounded-md">
